...
public class SlashPolicy
{
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
        ...
        Get the hash of the merkle root of the pre-images for the height

        Params:
            height = the desired block height to look up the hash for

        Returns:
            the hash of the merkle root of the pre-images
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
        ...
        Check if the the validator is valid for a height

        This checks if a validator has a pre-image for the height
        ...
        Returns:
            true if the validator has a right pre-image
...
unittest
{
    ...
    // get and check pre-image root
    Hash preimage_root = slash_man.getPreimageRoot(Height(2));
